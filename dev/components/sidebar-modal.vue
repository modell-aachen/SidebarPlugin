...
<div class="sidebar-modal">
  ...
  <div class="modal-content">
    ...
    <div v-if="config.content" v-html="config.content"></div>
    <div v-if="config.buttons" class="modal-buttons">
      <sidebar-button color="primary"
        v-if="config.buttons.confirm"
        :text="config.buttons.confirm.text"
        @click="confirm" />
      <sidebar-button color="secondary"
        v-if="config.buttons.cancel"
